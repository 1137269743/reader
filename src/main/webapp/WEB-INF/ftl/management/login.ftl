...
<head>
    ...
    <style>
        ...
        .login-main .login-bottom .center .item .icon-1 {background:url(/resources/images/icon-login.png) no-repeat 1px 0;}
        .login-main .login-bottom .center .item .icon-2 {background:url(/resources/images/icon-login.png) no-repeat -54px 0;}
        .login-main .login-bottom .center .item .icon-3 {background:url(/resources/images/icon-login.png) no-repeat -106px 0;}
        .login-main .login-bottom .center .item .icon-4 {background:url(/resources/images/icon-login.png) no-repeat 0 -43px;position:absolute;right:-10px;cursor:pointer;}
        .login-main .login-bottom .center .item .icon-5 {background:url(/resources/images/icon-login.png) no-repeat -55px -43px;}
        .login-main .login-bottom .center .item .icon-6 {background:url(/resources/images/icon-login.png) no-repeat 0 -93px;position:absolute;right:-10px;margin-top:8px;cursor:pointer;}
        ...
        .login-main .login-bottom .tip .icon-check {margin:0 7px 0 0;width:14px;height:14px;border:none;background:url(/resources/images/icon-login.png) no-repeat -111px -48px;}
        ...
        body {background:url(/resources/images/loginbg.png) 0% 0% / cover no-repeat;position:static;font-size:12px;}
...
<script src="/resources/jquery.3.3.1.min.js" charset="utf-8"></script>
<script src="/resources/layui/layui.js" charset="utf-8"></script>
<script src="/resources/jquery.particleground.min.js" charset="utf-8"></script>
<script>
